...
The legend was moved into a vertical position on top of the graph in order to improve readability, despite the fact that it differs slightly from the layout of the original infographic.